// Exercício 8: Aceleração Contínua

// Em vez de aumentar a velocidade a cada clique, fazer a velocidade aumentar enquanto a tecla está pressionada (vai acelerando aos poucos).

// Dica: use uma variável velocidade que aumenta dentro de setInterval.
