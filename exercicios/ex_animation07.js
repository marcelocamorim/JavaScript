// Exercício 7: Movimento Diagonal

// Permitir que o carro ande na diagonal quando duas teclas são pressionadas juntas (ex.: ↑ + → vai pra cima e direita).

// Dica: use keydown + keyup para saber quando várias teclas estão pressionadas.
